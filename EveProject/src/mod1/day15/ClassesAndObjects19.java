 ...
 * So in this case using if-else-if or switch case is highly discouraged or rather
 ...
 */
/*
 * Solution - the strategy to write programs without if-else-if
 ...
 * 5. Create an association between the abstract class and the using class
 *
